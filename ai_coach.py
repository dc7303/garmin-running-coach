"""
AI Coach module using Google Gemini API.
...
class AICoach:
    """AI running coach powered by Google Gemini."""

    def __init__(self, api_key: str):
        """
        Initialize AI Coach with Gemini API key.
    ...
    def _build_activity_prompt(self, activity: dict) -> str:
        ...
        prompt = f"""
Analyze this running activity and provide coaching feedback:
...
"""
        ...
        prompt = f"""
Analyze this runner's training pattern and provide coaching feedback:
...
"""
    ...
    def get_weekly_analysis(
        ...
        Args:
            weekly_stats: List of weekly statistics
            activities: Recent activities list
    ...
    def get_race_prediction(
        ...
        Args:
            recent_activities: List of recent running activities
            target_distance: Target race distance (5k, 10k, half_marathon, marathon)

        Returns:
            AI-generated prediction string
        """
        ...
        prompt = f"""
Based on this runner's recent training data, predict their potential race time
for {distance_name}:
...
"""
    ...
    def get_custom_advice(self, question: str, context: dict) -> str:
        ...
        Args:
            ...
            context: Dictionary with relevant running data
        ...
        prompt = f"""
You are an experienced running coach. A runner has the following question:
